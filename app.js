    ...
    levels: [
      {
        ...
        cards: [
          ...
          { korean: "가", romanization: "ga", english: "Consonant: 'g' or 'k'", tip: "ㄱ: like 'g' in 'go' at the start of a syllable, 'k' at the end. L-shaped letter.", breakdown: "ㄱ (g/k) + ㅏ (a) = 가 — G consonant sound" },
          { korean: "나", romanization: "na", english: "Consonant: 'n'", tip: "ㄴ: like 'n' in 'no'. Shaped like an angled L — always N.", breakdown: "ㄴ (n) + ㅏ (a) = 나 — N consonant sound" },
          { korean: "다", romanization: "da", english: "Consonant: 'd' or 't'", tip: "ㄷ: like 'd' in 'do' at the start, 't' at the end. Looks like a backwards C.", breakdown: "ㄷ (d/t) + ㅏ (a) = 다 — D consonant sound" },
          { korean: "라", romanization: "ra", english: "Consonant: 'r' or 'l'", tip: "ㄹ: a tongue-flap between R and L. R between vowels, L at the end of a syllable.", breakdown: "ㄹ (r/l) + ㅏ (a) = 라 — R consonant sound" },
          { korean: "마", romanization: "ma", english: "Consonant: 'm'", tip: "ㅁ: like 'm' in 'mother'. Looks like a small square.", breakdown: "ㅁ (m) + ㅏ (a) = 마 — M consonant sound" },
          { korean: "바", romanization: "ba", english: "Consonant: 'b' or 'p'", tip: "ㅂ: like 'b' in 'boy' at the start, 'p' at the end. Looks like a π.", breakdown: "ㅂ (b/p) + ㅏ (a) = 바 — B consonant sound" },
          { korean: "사", romanization: "sa", english: "Consonant: 's'", tip: "ㅅ: like 's' in 'sun'. Looks like a person with arms out.", breakdown: "ㅅ (s) + ㅏ (a) = 사 — S consonant sound" },
          { korean: "아", romanization: "a", english: "Consonant: silent / 'ng'", tip: "ㅇ: silent at the start of a syllable (placeholder). Sounds like 'ng' at the end.", breakdown: "ㅇ (silent) + ㅏ (a) = 아 — ㅇ is a silent filler here" },
          { korean: "자", romanization: "ja", english: "Consonant: 'j'", tip: "ㅈ: like 'j' in 'jump'. Looks like ㅅ with a crossbar.", breakdown: "ㅈ (j) + ㅏ (a) = 자 — J consonant sound" },
          { korean: "하", romanization: "ha", english: "Consonant: 'h'", tip: "ㅎ: like 'h' in 'hello'. Looks like a circle with a hat.", breakdown: "ㅎ (h) + ㅏ (a) = 하 — H consonant sound" },
        ],
        scenarios: []
      },
      {
        ...
        cards: [
          ...
          { korean: "카", romanization: "ka", english: "Aspirated: strong 'k'", tip: "ㅋ: ㄱ with an extra stroke. A stronger 'k' with a puff of air — like 'k' in 'kite'.", breakdown: "ㅋ (k) + ㅏ (a) = 카 — aspirated K sound" },
          { korean: "타", romanization: "ta", english: "Aspirated: strong 't'", tip: "ㅌ: ㄷ with extra strokes. A stronger 't' with a puff of air — like 't' in 'top'.", breakdown: "ㅌ (t) + ㅏ (a) = 타 — aspirated T sound" },
          { korean: "파", romanization: "pa", english: "Aspirated: strong 'p'", tip: "ㅍ: ㅂ extended. A stronger 'p' with a puff of air — like 'p' in 'park'.", breakdown: "ㅍ (p) + ㅏ (a) = 파 — aspirated P sound" },
          { korean: "차", romanization: "cha", english: "Aspirated: 'ch'", tip: "ㅊ: ㅈ with a stroke on top. Like 'ch' in 'church' with a puff of air.", breakdown: "ㅊ (ch) + ㅏ (a) = 차 — aspirated CH sound" },
          { korean: "까", romanization: "kka", english: "Tense: 'kk'", tip: "ㄲ: doubled ㄱ. Clipped, tense — no puff of air. Like 'k' in 'sky'.", breakdown: "ㄲ (kk) + ㅏ (a) = 까 — tense KK sound" },
          { korean: "따", romanization: "tta", english: "Tense: 'tt'", tip: "ㄸ: doubled ㄷ. Tense 't' — like the 't' in 'star', no aspiration.", breakdown: "ㄸ (tt) + ㅏ (a) = 따 — tense TT sound" },
          { korean: "빠", romanization: "ppa", english: "Tense: 'pp'", tip: "ㅃ: doubled ㅂ. Tense 'p' — like the 'p' in 'spa', very clipped.", breakdown: "ㅃ (pp) + ㅏ (a) = 빠 — tense PP sound" },
          { korean: "싸", romanization: "ssa", english: "Tense: 'ss'", tip: "ㅆ: doubled ㅅ. A sharp hissing 's'. Heard in 있어요 (isseoyo = there is).", breakdown: "ㅆ (ss) + ㅏ (a) = 싸 — tense SS sound" },
          { korean: "짜", romanization: "jja", english: "Tense: 'jj'", tip: "ㅉ: doubled ㅈ. A sharp, stiff 'j' sound. Less common but important to recognise.", breakdown: "ㅉ (jj) + ㅏ (a) = 짜 — tense JJ sound" },
        ],
        scenarios: []
      },
      {
